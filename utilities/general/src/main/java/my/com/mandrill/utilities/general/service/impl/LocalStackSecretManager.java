...
public class LocalStackSecretManager implements SecretManager {

	private final SecretManagerProperties secretManagerProperties;

	public LocalStackSecretManager(SecretManagerProperties secretManagerProperties) {
	...
	private AWSSecretsManager secretManagerClient() {
		return AWSSecretsManagerClientBuilder.standard()
				.withEndpointConfiguration(
						new AwsClientBuilder.EndpointConfiguration("http://host.docker.internal:4566", getRegion()))
